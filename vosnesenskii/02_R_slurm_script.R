#!/bin/bash
#SBATCH -J 02_supernova_ass.job # Name for your job
...
#SBATCH -o job.02-supernova-de-novo-ass-%A.out # Standard out goes to this file
#SBATCH -e job.02-supernova-de-novo-ass-%A.err # Standard err goes to this file
